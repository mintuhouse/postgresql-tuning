...
/**
	...
	*
	* Creating a reserved keyword for hypothetical.
	* This will be used in statements like: explain hypothetical.
	*/
PG_KEYWORD("hypothetical", HYPOTHETICAL, RESERVED_KEYWORD)
